...
def _resolve_attack(
    ...
    if not can_parry and defender_fighter.can_interrupt() and (
        ...
        and len(defender_fighter.actions_remaining) >= 2
    ...
    if can_parry and def_parry_rank > 0:
        ...
        if predeclared:
            ...
            remaining = sorted(defender_fighter.actions_remaining, reverse=True)
        ...
        if parry_auto_succeeds:
            ...
            defender_fighter.on_parry_attempt(True, 0)
        ...
        defender_fighter.on_parry_attempt(parry_succeeded, margin)
        temp_void_delta = defender_fighter.temp_void - _old_temp_void
